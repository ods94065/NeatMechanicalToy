...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'bookservices_librarybook', (
            ('isbn_13', self.gf('django.db.models.fields.BigIntegerField')(unique=True, primary_key=True, db_index=True)),
            ('isbn_10', self.gf('django.db.models.fields.PositiveIntegerField')(null=True)),
    ...
    models = {
        ...
        u'bookservices.librarybook': {
            ...
            'isbn_10': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
