...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserToStore'
        db.create_table(u'bookservices_usertostore', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('store', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bookservices.Store'])),
            ('permission', self.gf('django.db.models.fields.CharField')(default='rw', max_length=15)),
        ))
        db.send_create_signal(u'bookservices', ['UserToStore'])
    ...
    def backwards(self, orm):
        # Deleting model 'UserToStore'
        db.delete_table(u'bookservices_usertostore')
