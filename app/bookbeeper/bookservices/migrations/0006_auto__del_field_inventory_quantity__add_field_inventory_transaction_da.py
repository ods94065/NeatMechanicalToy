...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'bookservices_inventory', 'quantity')

        # Adding field 'Inventory.transaction_date'
        db.add_column(u'bookservices_inventory', 'transaction_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 8, 25, 0, 0)),
                      keep_default=False)

        # Adding field 'Inventory.transaction_type'
        db.add_column(u'bookservices_inventory', 'transaction_type',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'bookservices_inventory', 'quantity',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Inventory.transaction_date'
        db.delete_column(u'bookservices_inventory', 'transaction_date')

        # Deleting field 'Inventory.transaction_type'
        db.delete_column(u'bookservices_inventory', 'transaction_type')
